...
public class DateTimeGetMinute extends QBuiltinFunc {

    public DateTimeGetMinute(Runtime runtime) {
        super(
                "getMinute",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        return Val(instant.atZone(ZoneId.of(thisObject.getTimezone())).getMinute());
    }
