...
public class SurfaceFuncFillPoly extends QBuiltinFunc {


    public SurfaceFuncFillPoly(Runtime runtime) {
        super(
                "fillPoly",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        thisSurface.graphics.fillPolygon(xPoints, yPoints, pointCount);
