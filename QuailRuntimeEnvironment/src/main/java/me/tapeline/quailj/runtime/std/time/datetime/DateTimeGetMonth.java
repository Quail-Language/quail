...
public class DateTimeGetMonth extends QBuiltinFunc {

    public DateTimeGetMonth(Runtime runtime) {
        super(
                "getMonth",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        return Val(instant.atZone(ZoneId.of(thisObject.getTimezone())).getMonthValue());
    }
