...
public class DateTimeGetSecond extends QBuiltinFunc {

    public DateTimeGetSecond(Runtime runtime) {
        super(
                "getSecond",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        return Val(instant.atZone(ZoneId.of(thisObject.getTimezone())).getSecond());
    }
