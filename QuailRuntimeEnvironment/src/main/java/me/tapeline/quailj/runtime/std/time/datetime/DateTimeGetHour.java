...
public class DateTimeGetHour extends QBuiltinFunc {

    public DateTimeGetHour(Runtime runtime) {
        super(
                "getHour",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        return Val(instant.atZone(ZoneId.of(thisObject.getTimezone())).getHour());
    }
