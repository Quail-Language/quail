...
public class StringFuncIsAlphaNumeric extends QBuiltinFunc {

    public StringFuncIsAlphaNumeric(Runtime runtime) {
        super(
                "isAlphaNumeric",
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) {
        ...
        return Val(StringUtils.isAlphanumericSpace(thisString));
    }
