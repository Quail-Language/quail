...
public class DateTimeGetYear extends QBuiltinFunc {

    public DateTimeGetYear(Runtime runtime) {
        super(
                "getYear",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        return Val(instant.atZone(ZoneId.of(thisObject.getTimezone())).getYear());
    }
