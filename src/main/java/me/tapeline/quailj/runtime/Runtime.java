...
public class Runtime {
    ...
    private void registerDefaults() {
        ...
        QObject.superObject.set("table", new ObjectFuncTable(this), new int[0]);

        memory.set("List", QList.prototype, new int[0]);
        QList.prototype.set("add", new ListFuncAdd(this), new int[0]);
        QList.prototype.set("addAll", new ListFuncAddAll(this), new int[0]);
        QList.prototype.set("clear", new ListFuncClear(this), new int[0]);
        QList.prototype.set("count", new ListFuncCount(this), new int[0]);
        QList.prototype.set("find", new ListFuncFind(this), new int[0]);
        QList.prototype.set("findFromRight", new ListFuncFindFromRight(this), new int[0]);
        QList.prototype.set("get", new ListFuncGet(this), new int[0]);
        QList.prototype.set("insert", new ListFuncInsert(this), new int[0]);
        QList.prototype.set("joined", new ListFuncJoined(this), new int[0]);
        QList.prototype.set("pop", new ListFuncPop(this), new int[0]);
        QList.prototype.set("remove", new ListFuncRemove(this), new int[0]);
        QList.prototype.set("removeElementAt", new ListFuncRemoveElementAt(this), new int[0]);
        QList.prototype.set("reversed", new ListFuncReversed(this), new int[0]);
        QList.prototype.set("set", new ListFuncSet(this), new int[0]);
        QList.prototype.set("size", new ListFuncSize(this), new int[0]);
        QList.prototype.set("sort", new ListFuncSort(this), new int[0]);
        QList.prototype.set("sorted", new ListFuncSorted(this), new int[0]);
                
        memory.set("String", QString.prototype, new int[0]);
        QString.prototype.set("capitalized", new StringFuncCapitalized(this), new int[0]);
        QString.prototype.set("centered", new StringFuncCentered(this), new int[0]);
        QString.prototype.set("chars", new StringFuncChars(this), new int[0]);
        QString.prototype.set("count", new StringFuncCount(this), new int[0]);
        QString.prototype.set("decoded64", new StringFuncDecoded64(this), new int[0]);
        QString.prototype.set("encoded64", new StringFuncEncoded64(this), new int[0]);
        QString.prototype.set("endsWith", new StringFuncEndsWith(this), new int[0]);
        QString.prototype.set("find", new StringFuncFind(this), new int[0]);
        QString.prototype.set("findFromRight", new StringFuncFindFromRight(this), new int[0]);
        QString.prototype.set("format", new StringFuncFormat(this), new int[0]);
        QString.prototype.set("inBetweenOf", new StringFuncInBetweenOf(this), new int[0]);
        QString.prototype.set("isAlphabetical", new StringFuncIsAlphabetical(this), new int[0]);
        QString.prototype.set("isAlphaNumeric", new StringFuncIsAlphaNumeric(this), new int[0]);
        QString.prototype.set("isLower", new StringFuncIsLower(this), new int[0]);
        QString.prototype.set("isNumeric", new StringFuncIsNumeric(this), new int[0]);
        QString.prototype.set("isUpper", new StringFuncIsUpper(this), new int[0]);
        QString.prototype.set("lowerCased", new StringFuncLowerCased(this), new int[0]);
        QString.prototype.set("replaceAll", new StringFuncReplaceAll(this), new int[0]);
        QString.prototype.set("replaceFirst", new StringFuncReplaceFirst(this), new int[0]);
        QString.prototype.set("reversed", new StringFuncReversed(this), new int[0]);
        QString.prototype.set("size", new StringFuncSize(this), new int[0]);
        QString.prototype.set("split", new StringFuncSplit(this), new int[0]);
        QString.prototype.set("startsWith", new StringFuncStartsWith(this), new int[0]);
        QString.prototype.set("swappedCase", new StringFuncSwappedCase(this), new int[0]);
        QString.prototype.set("upperCased", new StringFuncUpperCased(this), new int[0]);

        memory.set("Dict", QDict.prototype, new int[0]);
        QDict.prototype.set("assemblePairs", new DictFuncAssemblePairs(this), new int[0]);
        QDict.prototype.set("clear", new DictFuncClear(this), new int[0]);
        QDict.prototype.set("containsKey", new DictFuncContainsKey(this), new int[0]);
        QDict.prototype.set("get", new DictFuncGet(this), new int[0]);
        QDict.prototype.set("keys", new DictFuncKeys(this), new int[0]);
        QDict.prototype.set("pairs", new DictFuncPairs(this), new int[0]);
        QDict.prototype.set("set", new DictFuncSet(this), new int[0]);
        QDict.prototype.set("size", new DictFuncSize(this), new int[0]);
        QDict.prototype.set("values", new DictFuncValues(this), new int[0]);
        ...
        memory.set("AssertionException", QAssertionException.prototype, new int[0]);
        memory.set("CircularDependencyException", QCircularDependencyException.prototype, new int[0]);
        memory.set("DerivationException", QDerivationException.prototype, new int[0]);
        memory.set("IOException", QIOException.prototype, new int[0]);
        memory.set("IterationNotStartedException", QIterationNotStartedException.prototype, new int[0]);
        memory.set("IterationStopException", QIterationStopException.prototype, new int[0]);
        memory.set("UnsuitableTypeException", QUnsuitableTypeException.prototype, new int[0]);
        memory.set("UnsuitableValueException", QUnsuitableValueException.prototype, new int[0]);
        memory.set("UnsupportedConversionException", QUnsupportedConversionException.prototype, new int[0]);
        memory.set("UnsupportedIterationException", QUnsupportedIterationException.prototype, new int[0]);
        memory.set("UnsupportedOperationException", QUnsupportedOperationException.prototype, new int[0]);
        memory.set("UnsupportedStepSubscriptException", QUnsupportedStepSubscriptException.prototype, new int[0]);
        memory.set("UnsupportedSubscriptException", QUnsupportedSubscriptException.prototype, new int[0]);
        memory.set("UnsupportedUnaryOperationException", QUnsupportedUnaryOperationException.prototype, new int[0]);

        memory.set("all", new FuncAll(this), new int[0]);
        memory.set("any", new FuncAny(this), new int[0]);
        memory.set("clone", new FuncClone(this), new int[0]);
        ...
        memory.set("put", new FuncPut(this), new int[0]);
        memory.set("abs", new FuncAbs(this), new int[0]);
        memory.set("acos", new FuncAcos(this), new int[0]);
        memory.set("asin", new FuncAsin(this), new int[0]);
        memory.set("atan", new FuncAtan(this), new int[0]);
        memory.set("atan2", new FuncAtan2(this), new int[0]);
        memory.set("cos", new FuncCos(this), new int[0]);
        memory.set("cosh", new FuncCosh(this), new int[0]);
        memory.set("max", new FuncMax(this), new int[0]);
        memory.set("min", new FuncMin(this), new int[0]);
        memory.set("sin", new FuncSin(this), new int[0]);
        memory.set("sinh", new FuncSinh(this), new int[0]);
        memory.set("tan", new FuncTan(this), new int[0]);
        memory.set("tanh", new FuncTanh(this), new int[0]);
        memory.set("bin", new FuncBin(this), new int[0]);
