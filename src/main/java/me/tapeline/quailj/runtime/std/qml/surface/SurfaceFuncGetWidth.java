...
import me.tapeline.quailj.runtime.std.qml.window.QMLWindowNotInitializedException;
...
public class SurfaceFuncGetWidth extends QBuiltinFunc {


    public SurfaceFuncGetWidth(Runtime runtime) {
        super(
                "getWidth",
                Arrays.asList(
                        new FuncArgument(
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) throws RuntimeStriker {
        ...
        return Val(thisSurface.getImage().getWidth());
    }
}
