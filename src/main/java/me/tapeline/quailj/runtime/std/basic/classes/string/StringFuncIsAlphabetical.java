...
public class StringFuncIsAlphabetical extends QBuiltinFunc {

    public StringFuncIsAlphabetical(Runtime runtime) {
        super(
                "isAlphabetical",
    ...
    public QObject action(Runtime runtime, HashMap<String, QObject> args, List<QObject> argList) {
        ...
        return Val(StringUtils.isAlphaSpace(thisString));
    }
